...
class Uygulama extends Frame{
    ...
    //Başlat butonuna basıldığında çalışacak methot
    public void baslatButonuAction() {
        //Dosya ve MailGonder classları için nesne oluşturma
        ...
        //TextField'lardan bilgilerin alımı
        ...
        if (sure.isEmpty() || mail.isEmpty() || secim.isEmpty() || boyut == 0) {
            ...
            if(rbMouse.isSelected()){
                //sadece fare radiobutton u seçilmişse çalışacak olan kısım
                frame.addMouseMotionListener(new MouseMotionAdapter() {
                    ...
                    public void mouseMoved(MouseEvent e) {
                        ...
                        try (BufferedWriter writer = new BufferedWriter(new FileWriter("log.txt", true))) {
                            //alınan konumun dosyaya yazdırılması
    ...
    //Durdur butonuna basıldığında çalışmayı durduracak olan metot
...
public class Main {
    public static void main(String[] args) {
        //Uygulamayı çağırmak için nesne oluşturma
